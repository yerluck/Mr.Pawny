...
public class PlayerManager : Singleton<PlayerManager>
{
    ...
    [Range(0, 1000)][SerializeField] private float JumpForce = 400f;
    ...
    [SerializeField][Range(1f,20f)] private float FallMultiplyer = 2.5f;
    [SerializeField][Range(1f,20f)] private float LowJumpMultiplyer = 2f;
    [SerializeField][Range(1f,10f)] private float GravityScale = 2.5f;
    [SerializeField][Range(0f, 1f)] private float HangTime = 0.2f;
    [SerializeField][Range(0f, 1f)] private float AttackTimeCooldown = 0.1f;
